...
#
# mlp_accel_sys.tcl: Tcl script for re-creating project 'mlp_accel_sys'
#
# Generated by Vivado on Wed Apr 15 02:50:15 -0700 2026
...
#
# 1. This project restoration tcl script (mlp_accel_sys.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/simulbarua/Documents/ZyboProjects/mlp_accel_sys_v1.0/mlp_accel_sys.srcs/constrs_1/imports/constraints/zybo_z710_mlp.xdc"
#    "C:/Users/simulbarua/Documents/ZyboProjects/mlp_accel_sys_v1.0/mlp_accel_sys.srcs/utils_1/imports/synth_1/mlp_top.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/mlp_accel_sys.srcs/constrs_1/imports/constraints/zybo_z710_mlp.xdc"]"\
 "[file normalize "$origin_dir/mlp_accel_sys.srcs/utils_1/imports/synth_1/mlp_top.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "mlp_accel_sys"
...
set script_file "mlp_accel_sys.tcl"
...
set_property -name "top" -value "mlp_system_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/mlp_accel_sys.srcs/constrs_1/imports/constraints/zybo_z710_mlp.xdc]"
...
# Proc to create BD mlp_system
proc cr_bd_mlp_system { parentCell } {
  ...
  xilinx.com:user:mlp_acceleratror:1.0\
...
\
  ...
  # Create instance: mlp_acceleratror_0, and set properties
  set mlp_acceleratror_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mlp_acceleratror:1.0 mlp_acceleratror_0 ]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins mlp_acceleratror_0/s_axi]
  ...
  [get_bd_pins mlp_acceleratror_0/param_bram_rdata]
  ...
  [get_bd_pins mlp_acceleratror_0/input_bram_rdata]
  ...
  connect_bd_net -net mlp_acceleratror_0_input_bram_addr  [get_bd_pins mlp_acceleratror_0/input_bram_addr] \
  [get_bd_pins blk_mem_gen_1/addrb]
  connect_bd_net -net mlp_acceleratror_0_input_bram_en  [get_bd_pins mlp_acceleratror_0/input_bram_en] \
  [get_bd_pins blk_mem_gen_1/enb]
  connect_bd_net -net mlp_acceleratror_0_param_bram_addr  [get_bd_pins mlp_acceleratror_0/param_bram_addr] \
  [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net mlp_acceleratror_0_param_bram_en  [get_bd_pins mlp_acceleratror_0/param_bram_en] \
  [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn  [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins smartconnect_0/aresetn] \
  [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] \
  [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] \
  [get_bd_pins mlp_acceleratror_0/s_axi_aresetn]
  ...
  [get_bd_pins mlp_acceleratror_0/s_axi_aclk] \
  ...
  assign_bd_address -offset 0x40020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mlp_acceleratror_0/s_axi/reg0] -force
...
# End of cr_bd_mlp_system()

cr_bd_mlp_system ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files mlp_system.bd ] 
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/mlp_top.dcp" -objects $obj
